...
This project is indexed by GitNexus as **WebClaw** (81438 symbols, 227661 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/WebClaw/process/{processName}` — trace the full execution flow step by step
